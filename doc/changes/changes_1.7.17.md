...
Code name: Fixed vulnerability CVE-2026-1225 in ch.qos.logback:logback-core:jar:1.5.20:compile

## Summary

This release fixes the following vulnerability:

### CVE-2026-1225 (CWE-20) in dependency `ch.qos.logback:logback-core:jar:1.5.20:compile`
...
#### References
* https://ossindex.sonatype.org/vulnerability/CVE-2026-1225?component-type=maven&component-name=ch.qos.logback%2Flogback-core&utm_source=ossindex-client&utm_medium=integration&utm_content=1.8.1
* http://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2026-1225
* https://github.com/advisories/GHSA-qqpg-mvqg-649v

## Security

* #158: Fixed vulnerability CVE-2026-1225 in dependency `ch.qos.logback:logback-core:jar:1.5.20:compile`
...
* Updated `ch.qos.logback:logback-classic:1.5.20` to `1.5.25`
