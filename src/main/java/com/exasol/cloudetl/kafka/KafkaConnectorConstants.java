...
public final class KafkaConnectorConstants {
    ...
    public static final String AUTHORIZATION_ERROR_MESSAGE = "A consumer or a consumer group does not have access to read the given topic. Cause: ";
    ...
    public static final String AUTHENTICATION_ERROR_MESSAGE = "Failed to authenticate to the Kafka cluster. Cause: ";
